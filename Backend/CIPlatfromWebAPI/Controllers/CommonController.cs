...
public async Task<IActionResult> UploadImage([FromForm] UploadFile upload)
{
    ...
    // Define the upload folder for the assets
    string assetsFolderPath = "/Users/jaychaudhary/Desktop/jay chaudhary/coding/Summer_ Internship/DAY 1/src/assets/Images";
    ...
    if (!Directory.Exists(assetsFolderPath))
    {
        try
        {
            ...
            _logger.LogInformation($"Created directory: {assetsFolderPath}");
        }
        catch (Exception ex)
        {
    ...
    foreach (var file in Request.Form.Files)
    {
        ...
        string fullPath = Path.Combine(assetsFolderPath, fullFileName);
        ...
        try
        {
            ...
            fileList.Add(fullFileName.Replace("\\", "/")); // Save the full path in the response
        }
        catch (Exception ex)
        {
